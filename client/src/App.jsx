...
function App() {
  ...
  return (
    ...
    <GameContext.Provider value={{gameState, setGameState, playerScore, setPlayerScore, defeatReason, setDefeatReason, timeLeft, setTimeLeft, usedWords, setUsedWords, round, setRound}}>
